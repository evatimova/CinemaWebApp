using CinemaWeb.Domain;
using CinemaWeb.Domain.Identity;
using CinemaWeb.Repository;
using CinemaWeb.Repository.Implementation;
using CinemaWeb.Repository.Interface;
using CinemaWeb.Services.Implementation;
...
namespace CinemaWeb.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<CinemaWebApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
